...
whatpad/
  backend/
    ...
    src/
      ...
      modules/
        auth/ routes.js
        stories/ routes.js service.js
        chapters/ routes.js service.js
        comments/ routes.js
        favorites/ routes.js
        follows/ routes.js
        reading/ routes.js
  ...
  frontend/
    ...
    src/
      ...
      assests/
        images/
        styles/
          reset.css global.css variables.css
      components/
        Button/
        Card/
        StoryCard/
...
Ghi chú: Đã lược bỏ các file không quan trọng (ví dụ README phụ, asset icon rỗng, các file test phụ) để cây thư mục gọn hơn; chỉ liệt kê những thư mục/chức năng chính thể hiện kiến trúc dự án.
